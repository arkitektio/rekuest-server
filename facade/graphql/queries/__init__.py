...
__all__ = ["AgentDetailQuery", "Agents", "AssignationDetailQuery", "Assignation", "MyAssignations", "NodeDetailQuery", "Node", "Nodes", "ReservationDetailQuery", "Reservation", "MyReservations", "RepoDetailQuery", "TemplateDetailQuery", "Template", "Templates", "Structure", "StructureDetailQuery", "Structures", "Provision", "MyProvisions", "Provisions", "ProvisionDetailQuery"]