# Generated by Django 3.2.8 on 2022-03-30 09:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='Unnamed', help_text='A name for this registzry', max_length=2000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, help_text='Was this Reservation caused by a Provision?', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='caused_reservations', to='facade.provision')),
        ...
        migrations.AddConstraint(
            model_name='reservation',
            constraint=models.UniqueConstraint(fields=('params', 'node', 'waiter'), name='Equal Reservation on this App by this Waiter is already in place'),
        ),
        migrations.AddConstraint(
            model_name='registry',
