# Generated by Django 3.2.8 on 2021-11-15 14:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bound', models.ForeignKey(blank=True, help_text='Is this Provision bound to a certain Agent?', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bound_provisions', to='facade.agent')),
                ...
                ('provision', models.ForeignKey(blank=True, help_text='Provision that created this provision (if we were auto created)', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='created_provisions', to='facade.provision')),
            ],
        ),
        migrations.CreateModel(
            name='Registry',
            fields=[
                ...
                ('name', models.CharField(default=mars.names.generate_random_name, help_text='A name for this registzry', max_length=2000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('causing_provision', models.ForeignKey(blank=True, help_text='Was this Reservation caused by a Provision', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='caused_reservations', to='facade.provision')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.CharField(blank=True, help_text='A short descriptor for the kind of version', max_length=400, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bound', models.CharField(choices=[('AGENT', 'Bound to one Agent (Instance Dependented)'), ('REGISTRY', 'Registry (User Dependent)'), ('APP', 'Bound to one Application (User independent)'), ('GLOBAL', 'Unbound and usable for every application')], default='GLOBAL', max_length=1000)),
                ('repository', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='models', to='facade.repository')),
            ],
        ),
        migrations.CreateModel(
            name='ReservationLog',
        ...
        migrations.AddConstraint(
            model_name='template',
            constraint=models.UniqueConstraint(fields=('node', 'version', 'registry'), name='A template has unique versions for every node it trys to implement'),
        ),
        migrations.AddConstraint(
            model_name='registry',
            constraint=models.UniqueConstraint(fields=('app', 'user'), name='No multiple Registry for same App and User allowed'),
        ),
        migrations.AddConstraint(
            model_name='node',
            constraint=models.UniqueConstraint(fields=('repository', 'interface'), name='repository, interface, cannot be the same'),
        ),
        migrations.AddField(
