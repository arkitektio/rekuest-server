    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unique', models.CharField(default=uuid.uuid4, max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('provider_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='facade.provider')),
                ('host', models.CharField(help_text='External Clients are authorized via the App ID', max_length=6000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channel', models.CharField(default=uuid.uuid4, help_text='The unique channel where we can reach pods of this template', max_length=1000, unique=True)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('host', 'port'), name='No multiple Providers for same Service allowed'),
        ),
        migrations.AddConstraint(
            model_name='pod',
