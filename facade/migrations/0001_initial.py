    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scope', models.CharField(default='GLOBAL', help_text='The scope of this Node. e.g. does the data it needs or produce live only in the scope of this Node or is it global or does it bridge data?', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statusmessage', models.CharField(blank=True, help_text='Clear Text status of the Provision as for now', max_length=10000)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(help_text='The Associatsed App', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Repository',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('agent', models.ForeignKey(help_text='The associated registry for this Template', on_delete=django.db.models.deletion.CASCADE, related_name='templates', to='facade.agent')),
        ...
        migrations.AddConstraint(
            model_name='template',
            constraint=models.UniqueConstraint(fields=('interface', 'agent'), name='A template has unique versions for every node it trys to implement'),
        ),
        migrations.AddConstraint(
            model_name='reservation',
