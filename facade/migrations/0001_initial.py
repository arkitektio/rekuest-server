...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='Nana', help_text='This hookers name', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Commission',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('PROVIDING', 'Providing'), ('DENIED', 'Denied (Provision was rejected)'), ('ENDED', 'Reservation has finished and is no longer active'), ('PROGRESS', 'Progress (Provision has current Progress)'), ('ERROR', 'Error (Retrieable)'), ('CRITICAL', 'Critical Error (No Retries available)'), ('CANCEL', 'Provision is beeing cancelled'), ('CANCELLED', 'Provision has been cancelled.'), ('DONE', 'Reservation is active and assignable')], default='PENDING', help_text='Current lifecycle of Provision', max_length=300)),
                ('statusmessage', models.CharField(blank=True, help_text='Clear Text status of the Provision as for now', max_length=1000)),
                ('callback', models.CharField(blank=True, help_text='Callback', max_length=1000, null=True)),
                ('progress', models.CharField(blank=True, help_text='Provider', max_length=1000, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
