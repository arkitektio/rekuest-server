    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "extensions",
                    models.JSONField(default=dict, help_text="The Platform extensions"),
                ),
                (
                    "context",
                    models.JSONField(default=dict, help_text="The Platform context"),
                ),
                ("args", models.JSONField(blank=True, help_text="The Args", null=True)),
                (
                    "kwargs",
                    models.JSONField(blank=True, help_text="The Kwargs", null=True),
                ),
                (
                    "returns",
                    models.JSONField(blank=True, help_text="The Returns", null=True),
                ),
                (
                    "status",
                    models.CharField(
                        choices=[
                            ...
                            ("RETURNED", "Assignation Returned (Only for Functions)"),
                            ("DENIED", "Denied (Assingment was rejected)"),
                            ("ASSIGNED", "Was able to assign to a pod"),
                            ("PROGRESS", "Progress (Assignment has current Progress)"),
                            (
                                "RECEIVED",
                                "Received (Assignment was received by an agent)",
                            ),
                            ("ERROR", "Error (Retrieable)"),
                            ("CRITICAL", "Critical Error (No Retries available)"),
                            ("CANCEL", "Assinment is beeing cancelled"),
                            (
                                "CANCELING",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("generator", "Generator"), ("function", "Function")],
                        default="function",
                ...
                (
                    "package",
                    models.CharField(
                        help_text="Package (think Module)", max_length=1000
                    ),
                ),
                (
                    "interface",
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        help_text="Beautiful images for beautiful Nodes",
                        null=True,
                        upload_to="",
                    ),
                ),
                (
                    "args",
                    facade.fields.ArgsField(
                        default=list, help_text="Inputs for this Node"
                    ),
                ),
                (
                    "kwargs",
                    facade.fields.KwargsField(
                        default=list, help_text="Inputs for this Node"
                    ),
                ),
                (
                    "returns",
                    facade.fields.ReturnField(
                        default=list, help_text="Outputs for this Node"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("DEBUG", "Debug Mode (Node might be constantly evolving)"),
                            (
                                "PRODUCTION",
                ...
                (
                    "extensions",
                    models.JSONField(
                        blank=True, help_text="The Platform extensions", null=True
                    ),
                ),
                (
                    "context",
                    models.JSONField(
                        blank=True, help_text="The Platform context", null=True
                    ),
                ),
                (
                    "access",
                    models.CharField(
                        choices=[
                            ...
                            ("EVERYONE", "Everyone can link to this Topic"),
                        ],
                        default="EVERYONE",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("DENIED", "Denied (Provision was rejected for this User)"),
                            (
                                "ERROR",
                ...
                (
                    "callback",
                    models.CharField(
                        blank=True, help_text="Callback", max_length=1000, null=True
                    ),
                ),
                (
                    "progress",
                    models.CharField(
                        blank=True, help_text="Provider", max_length=1000, null=True
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default=uuid.uuid4,
                        help_text="A world-unique identifier",
                        max_length=1000,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("app", "Repository that is hosted by an App"),
                            ("mirror", "Repository mirrors online Repository"),
                        ],
                        default="app",
                        max_length=4000,
                    ),
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The name of this Repository", max_length=1000
                    ),
                ),
                (
                    "unique",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("AGENT", "Bound to one Agent (Instance Dependented)"),
                            ("REGISTRY", "Registry (User Dependent)"),
                            ("APP", "Bound to one Application (User independent)"),
                            ("GLOBAL", "Unbound and usable for every application"),
                        ],
                        default="GLOBAL",
                        max_length=1000,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("RETURN", "YIELD Level"),
                            ("DONE", "Done Level"),
                            ("EVENT", "Event Level (only handled by plugins)"),
                        ],
                        default="INFO",
                        max_length=200,
                    ),
