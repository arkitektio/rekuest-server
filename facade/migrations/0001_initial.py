    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('INFO', 'INFO Level'), ('DEBUG', 'DEBUG Level'), ('ERROR', 'ERROR Level'), ('WARN', 'WARN Level')], default='INFO', max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='DataModel',
