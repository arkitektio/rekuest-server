...
def get_session_app():
    ...
    if SESSION_APP is None:
        ...
        SESSION_APP, created = HerreApp.objects.get_or_create(client_id="session", name="Session", grant_type=HerreGrantType.SESSION.value)
...
class Bounced:
    ...
    def bounce(self, required_roles=[], required_scopes=[], anonymous=False, only_jwt=False):
        ...
        # Scope tests
        if self._app.grant_type == HerreGrantType.PASSWORD.value:
            return True
