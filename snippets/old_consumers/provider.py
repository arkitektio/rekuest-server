...
from delt.messages import UnprovideLogMessage, UnprovideCriticalMessage, ProvideLogMessage, ProvideDoneMessage, ProvideCriticalMessage
...
class ProviderConsumer(BaseConsumer): #TODO: Seperate that bitch
    ...
    async def on_provide_related(self, message: aiormq.abc.DeliveredMessage):
        ...
        """
        logger.error("OINAOINSOINAOISNOASNPOIUFENPIOUJBNAEPFUIABNWDPOIUBNAWPIDUBNAIDUJIUDJUDJ")
